 ...
 */
	...
	$badwordslist = array(
		...
		'hitler','nutte','faitchier','bordel','shit',
		'encul','a.q','conerie','scheise','scheiße','scheis',
		'baskasole','cocugu','kodugumun','cazo','hoer',
		'fotze','maul','frese','pizda','gay','fuck','tyfus',
		'sugi','cacat','pisat','labagiu','gaozar','muist','orospu',
		'pédé','godve','godfe','kut','kudt','lul','iui');
