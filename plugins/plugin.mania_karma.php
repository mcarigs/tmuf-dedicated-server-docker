 ...
 * 91104		id for manialink Player-Marker for their Vote
...
//	}
	...
	// Tell the player the result for their vote
...
function mk_showReminderWindow ($players) {
	...
	$content .= '<quad posn="0 1 0" sizen="81.8 4.5" style="BgsPlayerCard" substyle="BgRacePlayerName"/>';
